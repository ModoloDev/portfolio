...
export const CERTIFICATES_PAGE: PAGE = {
  ...
  content: <section className='certificates'>
    <a className="certificate" href="https://www.credly.com/badges/64de666a-5e2d-4278-9143-57e2bcfc940e/public_url" target="_blank">
      <img className="certificateImage" src={awsCertifiedCloudPractitioner}/>
      <p className="certificateTitle">ARQUITETURA CSS: DESCOMPLICANDO OS PROBLEMAS</p>
    </a>
  </section>
}